...
- **★ 최대 발견 continuity ≠ payoff** — 21화 내내 연속성 완벽하나 전제(운명 전환) 페이오프 0, codex reveal 무한 연기, 아크 페이오프 게이트 부재. 쇼러너는 약하게만 신호.
- **종합 리포트 작성** — `docs/reviews/2026-06-07-persona-live-test/FINAL-REPORT-romancefantasy.md`(6축 점수: 연속성5·생성품질4·수정반응성4·매체4·UX3·상업3, 평균~3.8 · 차별점 입증 6항 · 권고 5 · 새 제작계획 A/B/C).

### 검증
- `bash init.sh` 직전 녹색(325 tests). 라이브 콘솔 0. #2 21화까지.

### 다음 (새 제작계획)
- **A. #2 해결 유도** — intent 메모로 배신자 확정·리아나 행동·운명 전환 유도해 codex 무한연기 끊고 완결(권고1 수동 우회). **← 본 세션에서 착수 중.**
- **B. #3 헌터물** 전환(다수 캐릭터 일관성). **C. 아크 페이오프 게이트 설계**(1.0 핵심 갭).

### 손대지 말 것
- P6·P5·relations 수정·테스트. #2 localStorage(21화까지·1~20 locked·characters [레나,리아나,레오르 벨로트라,백작부인]·canonFacts 81). "레오르 벨로트라"(P6 이전 데이터) 보존.
