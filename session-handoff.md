...
- **다음 후보** — (a) 갈림길 LLM 정제(pace-interview 패턴 재사용 — fork 옵션/시드를 LLM 으로 작품 맞춤화) (b) academic 라이브 검토 배선(1.0 실험 플래그 전제 조건) (c) M7 경량 검증 A/B/C — 사용자 선택 필요.
- 관찰 메모 — ch6 검토의 신규 용어("생존 부담률") 비용 정의 요구는 작품 내 후속 회차 과제(코드 아님).
