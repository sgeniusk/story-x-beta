...
- **2단계 실사용 사이클 완료(ch6 "감시를 켜는 밤")** — LLM 시드 3개 전부 생성 반영(행동 들킴·감시 역이용·전진=대가 lost), `[페이스] ` 자동 소거, 쇼러너 통과·연속성 무충돌("세 축 모두 행동과 대가로 진행" — 검토자가 시드 축을 독립 식별). 리포트 `06-hunter-pace-check.md` 2단계 실사용 절.
