...
function buildAgentReviewPrompt({ agentId, persona, target, medium, context, payoffStatus }) {
...
// 쇼러너 관점의 페이스 인터뷰 프롬프트 — storyx.mjs 미러.
// promptBuilders.ts 의 buildPaceInterviewPrompt 와 핵심 지시문 byte-identical 유지 — 변경 시 두 곳 동시 수정.
